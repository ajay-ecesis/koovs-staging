...
function mobilemenbanner({categoryName}) {

    {
        ...
        return (
            ...
            <section className="mobile_men_banner pb-5 d-block d-lg-none">
                <div className="container-fluid">
                    <div className="row g-lg-1">
                        <div className="stylestories">
                            <h5 className="fw-bold d-sm-block d-lg-none d-md-none mb-0 ">Influencer Collaboration</h5>
                            <p className="d-sm-block d-lg-none d-md-none mb-0"><u>View All</u></p>
                        </div>
                        <div className="row stories d-sm-block d-lg-none d-md-none" id="carousel-slide">
                            <Carousel infinite="true" partialVisible={true} interval={1000} touch={true} arrows={false} responsive={responsive} renderButtonGroupOutside={true} swipeable={true} draggable={false} autoPlay={true}
                                ...
                                <div className="cards overflow-hidden">
                                    <div className="img-content">
                                        <img src={MenBannerimg1} className="img-fluid" alt="Koovs image" />
                                       
                                    </div>
                                </div>
                                <div className="cards overflow-hidden">
                                    <div className="img-content">
                                        <img src={menbannerimg} className="img-fluid" alt="Koovs image" />
