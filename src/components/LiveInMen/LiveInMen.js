            ...
            <div className="col-12 col-lg-6">
              ...
              <div className="d-block d-lg-none">
                <Carousel controls={true} interval={700}>
                  <Carousel.Item>
                    <div className="banner-Image"><img src={videomenpage} className="w-100 img-fluid" alt="DMG banner Image" /></div>
                  </Carousel.Item>
                  <Carousel.Item>
                    <div className="banner-Image"><img src={videomenpage} alt="DMG banner Image" className="w-100 img-fluid" /></div>
                  </Carousel.Item>
                  <Carousel.Item>
                    <div className="banner-Image"><img src={videomenpage} alt="DMG banner Image" className="w-100 img-fluid" /></div>
                  </Carousel.Item>
